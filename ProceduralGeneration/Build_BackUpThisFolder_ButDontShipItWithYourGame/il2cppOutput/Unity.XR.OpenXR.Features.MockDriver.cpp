...
IL_0022:
	{
		...
		intptr_t L_4;
		L_4 = MockDriver_InitializeNative_mFF63260B5E7354460BFFA8654A178000C65CA0F2(L_2, L_3, ((int64_t)0), ((int64_t)0), NULL);
		// MockDriver_RegisterScriptEventCallback(ReceiveScriptEvent);
		ScriptEventDelegate_tAB5700EBE916CEAE5D6AC378A39A837AC2BC90B1* L_5 = (ScriptEventDelegate_tAB5700EBE916CEAE5D6AC378A39A837AC2BC90B1*)il2cpp_codegen_object_new(ScriptEventDelegate_tAB5700EBE916CEAE5D6AC378A39A837AC2BC90B1_il2cpp_TypeInfo_var);
		NullCheck(L_5);
		ScriptEventDelegate__ctor_mD5F27EA5643A1BD3D22D66C3D4FE89799B70930E(L_5, NULL, (intptr_t)((void*)MockDriver_ReceiveScriptEvent_m02DD920C8DD9F0F69295FF330269F1D3C1EBC49C_RuntimeMethod_var), NULL);
		int32_t L_6;
		L_6 = MockDriver_MockDriver_RegisterScriptEventCallback_m39C8E09B89D20375AF2DD3C8ACAD633B053C9779(L_5, NULL);
		// return true;
		V_1 = (bool)1;
		goto IL_0048;
	}
...
void ScriptEventDelegate_Invoke_mF63E757B2FD4E7B9D821D78385550716E7A20290_Multicast(ScriptEventDelegate_tAB5700EBE916CEAE5D6AC378A39A837AC2BC90B1* __this, int32_t ___evt0, uint64_t ___param1, const RuntimeMethod* method)
{
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		((FunctionPointerType)currentDelegate->___invoke_impl_1)(currentDelegate, ___evt0, ___param1, reinterpret_cast<RuntimeMethod*>(currentDelegate->___method_3));
	}
}
